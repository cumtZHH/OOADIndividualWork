...
%>
                            ...
                            <tr>
								...
								<td><%=info.getPrice()%></td>
								<td><%=info.getPtime()%></td>
								<td><img style="width:150px" src="<%=info.getPimg()%>"/></td><input type="hidden" name="pimg" value="<%=info.getPimg() %>">
                                <td align="center">
                                ...
                                <input type="button" data-pid="<%=info.getPid()%>" value="删除" class="btn" onclick="del_tr(this)" >
                                </td>
                            </tr>
                      <%} %>
                            <!--  
