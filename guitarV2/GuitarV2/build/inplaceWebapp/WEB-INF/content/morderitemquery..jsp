                ...
                <div class="details">
                    <div class="details_operation clearfix">
                        <div class="bui_select">
                            <a href="maddproduct"><input type="button" value="添&nbsp;&nbsp;加" class="add"></a>
                        </div>
                        <div class="fr">
                            <div class="text">
                                <span>商品编号：</span>
                    ...
                    <table class="table" cellspacing="0" cellpadding="0">
                        ...
                        <tbody>
                        <%
List list =orderitemdao.OrderItemShow();
...
%>
                            ...
                            <tr>
                                ...
                                <td><input type="checkbox" id="c1" class="check"><label for="c1" class="label"><%=info.getOpid() %></label></td>
