...
<body>
	...
	<form method="post" action="">
							...
							<div class="shopping-cont padding-shop">
								<ul class="list-unstyled">
									...
									<li><span class="order-item"><em>*</em></span>详 细 地 址：
										<input type="text" class="form-control fr" placeholder="最多输入20个汉字">
									</li><br/>
									<li><span class="order-item"><em>*</em></span>用  户  名：
										<input type="text" class="form-control fr" placeholder="最多输入10个汉字">
									</li><br/> 
									<li><span class="order-item"><em>*</em></span>收  货  人：
										<input type="text" class="form-control fr" placeholder="最多输入10个汉字">
									</li><br/> 
									<li><span class="order-item"><em>*</em></span>联 系 方 式：
										<input type="text" class="form-control fr" placeholder="如12345678901">
									</li><br/>
								</ul>
							</div>
						</div>
		...
		<button class="btn btn-primary btn-lg btn-block btn-danger" type="button">提交订单</button> 
