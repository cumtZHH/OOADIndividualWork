...
<body>
	<div class="topBar">
		...
		<p class="p">欢迎注册</p>
		<a class="pull-right" href="loginForm">已注册，请登录</a>
	</div>
	<hr/>
	<div class="container">
		<div class="row">
					...
					<form action="register.action" method="post">
						<div class="register-box">
							...
							<ul class="login list-unstyled">
								...
								<li><span class="reg-item"><i>*</i><span class="glyphicon glyphicon-lock"></span> 请设置密码：</span></li>
								<li><input type="password" class="form-control" placeholder="请输入您的密码"></li><br/>
								<li><span class="reg-item"><i>*</i><span class="glyphicon glyphicon-lock"></span> 请确认密码：</span></li>
								...
								<li><input name="caddress" type="text" class="form-control" placeholder="请输入您的地址"></li><br/>
						 ...
						 <a href=""> <input class="btn btn-primary btn-lg btn-danger" value="注 册&gt;&gt;" type="submit"/></a>
					</form>
					</div>
