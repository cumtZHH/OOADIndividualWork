...
<head id="Head1">
    ...
    <title>登录</title>
    <link href="mjs/themes/icon.css" rel="stylesheet" type="text/css" />
    <link href="mjs/themes/default/easyui.css" rel="stylesheet" type="text/css" />
    ...
    <script src="mjs/Cookie.js" type="text/javascript"></script>
...
<body>
    <div id="loginWindow" class="easyui-window" title="Login CRM" iconcls="icon-login"
        ...
        <div class="toolbar" style="text-align: center; margin-top: 20px;">
            <a href="#" class="easyui-linkbutton" iconcls="icon-no" id="aboutSys" style="margin-right: 10px;">
                No</a> <a href="#" class="easyui-linkbutton" iconcls="icon-ok" id="btnLogin" style="margin-left: 10px;">
                    Ok</a>
        </div>
    </div>
</body>
