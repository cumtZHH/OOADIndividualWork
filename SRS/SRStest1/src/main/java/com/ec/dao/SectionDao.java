...
public interface SectionDao {
	...
	@Results({
		...
		one=@One(select="com.ec.dao.CourseDao.selectCourseByNum",
	...
	@Results({
		...
		one=@One(select="com.ec.dao.ProfessorDao.selectProfessorBySsn",
				fetchType=FetchType.EAGER)),
		@Result(column="sectionNo",property="enrolledStudents",
		many=@Many(select="com.ec.dao.StudentDao.selectStudentBySectionNo",
				fetchType=FetchType.LAZY))
	})
	...
	@Results({
		@Result(id=true,column="sectionNo",property="sectionNo"),
		@Result(column="course_number",property="course",
		one=@One(select="dao.CourseDao.selectCourseByNum",
				fetchType=FetchType.EAGER)),
		@Result(column="professor_sn",property="professor",
		one=@One(select="dao.ProfessorDao.selectProfessorBySsn",
				fetchType=FetchType.EAGER)),
		@Result(column="sectionNo",property="enrolledStudents",
		many=@Many(select="dao.StudentDao.selectStudentBySectionNo",
				fetchType=FetchType.LAZY))
	})
